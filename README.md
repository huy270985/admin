...
- [Folder Structure](#folder-structure) - [Available Scripts](#available-scripts)
  - [npm start](#npm-start)
  - [npm test](#npm-test)
...
This project depends on aor-firebase-client. A custom lib fork from original project.
